                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        @csrf
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="name" type="text" class="form-control{{ $errors->has('nomecliente') ? ' is-invalid' : '' }}" name="nomecliente" value="{{ $ag->nomecliente }}" required autofocus>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control" name="servico" value="" id="exampleFormControlSelect1">
