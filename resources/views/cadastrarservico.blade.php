    ...
    <div class="container">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header text-center">{{ __('Cadastrar serviço') }}</div>
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('tipo_servico') ? ' is-invalid' : '' }}" name="tipo_servico" value="{{ old('tipo_servico') }}" required autofocus>
