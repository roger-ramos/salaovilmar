    ...
    <div class="container">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header text-center">{{ __('Editar serviço') }}</div>

                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Digite o nome do serviço') }}</label>

                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('tipo_servico') ? ' is-invalid' : '' }}" name="tipo_servico" value="{{ $servico->tipo_servico }}" required autofocus>
