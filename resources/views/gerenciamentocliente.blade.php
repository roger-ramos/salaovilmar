...
<div class="container-fluid">
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Gerenciar Agendamento</h1>
        <hr>
    </div>
</div>
<div class="container">
    <div class="row">
        ...
        <div class="col-auto"><a type="button" href="/home/agendar" class="btn btn-success btn-lg">Agendar horário +</a></div>
    </div>
 <br>
    <div class="row">
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($cabeleireiros as $cabeleireiro)
                                @if($agendamento->cabeleireiro_id == $cabeleireiro->id)
                                    {{ $cabeleireiro->nome }}
                                @endif
                            @endforeach
                        </td>
                        ...
                        <td><a href="/agendamento/editar/{{ $agendamento->id }}" type="submit" class="btn btn-primary">Editar</a>
                            <a href="/agendamento/cancelar/{{ $agendamento->id }}" class="btn btn-danger" type="submit">Cancelar</a></td>
                    </tr>
            @endif
            @endforeach
        </table>
