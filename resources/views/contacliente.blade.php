    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body text-center">
                ...
                <a href="/conta/editar"  class="btn btn-primary">Alterar dados pessoais</a>
                <a href="/conta/alterarsenha"  class="btn btn-info">Alterar senha</a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="card text-center">
            <div class="card-body">
                ...
                <p class="card-text"></p>
                <button class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">Excluir Conta</button>
            </div>
        </div>
    </div>
</div>
