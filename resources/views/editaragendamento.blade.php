...
<div class="container">
     <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="card">
                                <div class="card-header text-center">{{ __('Editar Agendamento') }}</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="form-group row">
                                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Selecione o cabeleireiro') }}</label>

                                                <div class="col-md-6">
                                                    <select class="form-control" name="cabeleireiro" id="exampleFormControlSelect1">
                                                        @foreach($cabeleireiros as $cabeleireiro)
                                                            <option>{{ $cabeleireiro->nome }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Selecione a data') }}</label>

                                            <div class="col-md-6">
                                                <input class="form-control{{ $errors->has('data') ? ' is-invalid' : '' }}" name="data" type="date" value="{{ $ag->data }}" id="example-date-input" required autofocus>
                                                @if ($errors->has('data'))
