...
<div class="container-fluid" >
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
        <h1 class="display-4">Área Administrativa - Gerenciar Serviços</h1>
        <hr>
        </div>
</div>
...
<div class="container"> 
              <div class="row">
                ...
                <div class="col-auto"><a type="button" href="/cadastrarservico" class="btn btn-success btn-lg">Cadastrar serviço +</a></div>
              </div>
    <br>
                    ...
                    <div class="row">
                        <table class="table table-inverse">
                            ...
                            @foreach($servicos as $servico)
                                ...
                                <td><a href="/servico/editar/{{ $servico->id }}" type="submit" class="btn btn-primary">Editar</a>
                                    <a href="/servico/remover/{{ $servico->id }}" class="btn btn-danger" type="submit">Excluir</a></td>
                            </tr>
                            @endforeach
                        </table>
